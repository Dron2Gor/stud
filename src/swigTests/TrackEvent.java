...
public class TrackEvent extends JFrame {
    ...
    private String[] event = {"focusGained", "focusLost", "keyPressed", "keyReleased",
            "keyTyped", "mouseClicked", "mouseEntered", "mouseExited", "mousePressed", "mouseReleased",
    ...
    class MyButton extends JButton {
        ...
        public MyButton(Color color, String lable) {
            super(lable);
            setBackground(color);
            addFocusListener(fl);
            addKeyListener(kl);
    ...
    public static void main(String[] args) {
        SwigConsole.run(new TrackEvent(),700,500);
    }
